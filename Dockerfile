...
RUN echo "Installing PHP extensions" \
    ...
    && docker-php-ext-enable  iconv mcrypt pdo_mysql pdo_pgsql pcntl zip bcmath simplexml xmlrpc soap pspell ldap mbstring mysql mysqli zip sockets bz2 gettext imagick gd igbinary \
    && ldconfig
